...
namespace Engine
{
	...
	public:
		...
		void selectSubFrame(const vu2d start, const vu2d size) const noexcept;
		void selectSubFrame(const uint32_t x, const uint32_t y, const uint32_t width, const uint32_t height) const noexcept;
		void resetSubFrame() const noexcept;
	...
	public:
		...
		void DrawSprite(const Sprite2D &sprite, const vf2d &pos, const vf2d &size, const Pixel tint = WHITE) const noexcept;
		void DrawSpriteWorld(const Sprite2D &sprite, const TransformedView &tv, const vf2d &pos, const vf2d &size, const Pixel tint = WHITE) const noexcept;
		void DrawSprite(const Sprite2D &sprite, const vf2d &tl, const vf2d &tr, const vf2d &bl, const vf2d &br, const Pixel tint = WHITE) const noexcept;
		void DrawDecal(const Decal &decal, const Pixel tint = WHITE) const noexcept;
		void DrawDecalWorld(const Decal &decal, const TransformedView &tv, const Pixel tint = WHITE) const noexcept;
		...
		Sprite2D getAsciiTable(const Resolution res = Resolution::MEDIUM) const noexcept;

		AspectRatio  getAspectRatio() const noexcept;
		SpriteShader getSpriteShader() const noexcept;
